...
<Section addTopPadding={false} id="about" class="bg-secondary">
  <Prose class="md:prose-h3:text-left md:prose-h4:text-left">
    ...
    for efficient asset management, reporting, and financial accounting. At iComps, I improved the efficiency of the React-based application by implementing robust features and streamlined the QA process by designing and running comprehensive end-to-end tests using Cypress and Playwright.
